<?php
    ...
    // sql insert
    $addOrderSql = "INSERT INTO orders(pName, quantity, pDescription, category, price, userId, orderStatus, orderTimeStamp, pImage) VALUES('$pName', $quantity, '$pDescription', '$category', $price, $original_UserNameId, '$orderStatus', '$orderTimeStamp', '$fileUploadedDestination')";
