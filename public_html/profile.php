        ...
        <div class="container-fluid">
            <div class="jumbotron m-4">
                ...
                <?php
                    ...
                    // ORDERS TABLE
                    $access == 'W' || $access == 'M' || $access == 'C' ? $accessOut = "<h4 style=\"font-weight:normal\">My Orders:</h4>" : $accessOut = "<h4 style=\"font-weight:normal\">Orders:</h4>"; 
                    echo $accessOut;
                    ...
                    if ($access == 'W' || $access == 'M' || $access == 'C') {
                        ...
                        $orderSql  = "SELECT * FROM `orders` WHERE userId = '$customerId' ORDER BY `orders`.`id` DESC";
                    } else {
                    ...
                    // END OF ORDERS TABLE
                     ...
                     // PRODUCTS TABLE (ADMIN, WEBMASTER, SHOP MANAGER)
